          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            {testResult && (
              ...
              >
                ...
                <span className="flex-1 whitespace-pre-line leading-relaxed">{testResult.message}</span>
              </div>
            )}
          </div>
        </div>
