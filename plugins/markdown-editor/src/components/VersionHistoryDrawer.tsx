                ...
                <div className="space-y-2 p-2 bg-slate-900 border border-slate-700 rounded-xl">
                  ...
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 text-[11px] bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg font-medium transition disabled:opacity-40"
                    >
                      保存里程碑
                    </button>
                  </div>
              ...
              {!gitStatus?.installed ? (
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full py-2 px-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-medium transition shadow-sm"
                  >
                    🌿 一键初始化 Git 本地仓库
                  </button>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[11px]">
                    <span className="text-slate-400">分支: <span className="font-mono text-emerald-400">{gitStatus.branch || 'main'}</span></span>
                  ...
                  <div className="flex flex-col gap-1.5">
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-1.5 text-xs text-slate-200 focus:outline-none focus:border-emerald-500 font-mono"
                      onKeyDown={(e) => {
                    ...
                    <button
                      ...
                      className="w-full py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-medium transition disabled:opacity-40"
                    >
                      {committing ? '提交中...' : '提交此文件 (Commit)'}
                    </button>
                  </div>
                </div>
              )}
        ...
        <div className="flex-1 flex flex-col bg-slate-950 overflow-hidden">
          ...
          <div className="h-11 border-b border-slate-800 px-4 flex items-center justify-between bg-slate-900/70 text-xs flex-shrink-0">
            <div className="flex items-center gap-3">
              ...
              <span className="text-emerald-400 font-medium">当前编辑内容</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => {
                  if (confirm('确定要将当前编辑器的内容恢复为该历史版本吗？')) {
                    onRestoreContent(compareText)
                    onClose()
                  }
                }}
                className="px-3.5 py-1 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-medium transition shadow-sm flex items-center gap-1"
              >
                <span>↩️</span>
                <span>恢复此版本</span>
              </button>
